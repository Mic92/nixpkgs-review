...
def test_pr_github_action_eval(
    ...
    with helpers.nixpkgs() as nixpkgs:
        ...
        zip_artifact_mock = MagicMock()
        zip_artifact_mock.status_code = 200
        zip_artifact_mock.content = mock_zip.getvalue()
        zip_artifact_mock.__enter__ = (
            lambda x: zip_artifact_mock
        )  # Support for context manager
        zip_artifact_mock.__exit__ = MagicMock()
        mock_requests.side_effect = [zip_artifact_mock]
