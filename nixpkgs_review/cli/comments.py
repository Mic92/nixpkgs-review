...
def get_comments(github_token: str, pr_num: int, remote: str) -> List[Union[Comment, Review]]:
...
def show_comments(args: argparse.Namespace) -> None:
    comments = get_comments(ensure_github_token(args.token), get_current_pr(), args.remote)
